clear; 
 Y=load('comparison.txt','-ascii');
clc;
 P = load('a_of_0_points_1_31jan.txt','-ascii');
...
%  plotprp([k_start:k_end;k_start:k_end;k_start:k_end]',[inj_67(k_start:k_end,1) inj_67(k_start:k_end,2) inj_67(k_start:k_end,3)],'1.25dp','Chamber',2,'\tau_i_g ,67%\DeltaP (ms)');
